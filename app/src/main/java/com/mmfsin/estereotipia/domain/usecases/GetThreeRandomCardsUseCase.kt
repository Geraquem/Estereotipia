...
class GetThreeRandomCardsUseCase @Inject constructor(private val repository: ICardsRepository) :
    BaseUseCaseNoParams<List<Card>?>() {

    override suspend fun execute(): List<Card>? = repository.getThreeRandomCards()
