...
import com.mmfsin.estereotipia.databinding.DialogCardChoiceBinding
import com.mmfsin.estereotipia.domain.models.Card
import com.mmfsin.estereotipia.presentation.dashboard.whoiswho.cards.dialogs.choice.ChoiceDialog.ActionType.FIRST_BUTTONS
import com.mmfsin.estereotipia.presentation.dashboard.whoiswho.cards.dialogs.choice.ChoiceDialog.ActionType.SECOND_BUTTONS
import com.mmfsin.estereotipia.presentation.dashboard.whoiswho.cards.dialogs.choice.ChoiceDialog.ResultType.LOOSER
import com.mmfsin.estereotipia.presentation.dashboard.whoiswho.cards.dialogs.choice.ChoiceDialog.ResultType.WINNER
    ...
    private fun finalAnswer(winner: Boolean) {
        ...
        binding.apply {
            ...
            if (winner) {
                ...
                nope.root.alpha = 0f
                card?.let { c -> Glide.with(requireContext()).load(c.image).into(ivLooserCard) }
